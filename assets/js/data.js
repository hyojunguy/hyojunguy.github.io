...
export const stats = [
  ...
  { value: "1,328", unit: "편", label: "공개 운영 중인 한국어 · 영어 기술 블로그" },
  { value: "174", unit: "개", label: "직접 만들어 굴리는 저장소" },
...
export const layers = [
  ...
  },
  {
    ...
    body:
      "오래 다뤄 온 영역을 에이전트로 확장해 곧바로 구현으로 옮깁니다. 저장소 174개를 그렇게 만들었고 " +
...
export const work = [
  ...
  },
  {
    ...
    summary: "한국어와 영어 기술 블로그를 세우고 직접 운영합니다. 지금까지 2,260편을 쓰고 1,328편을 공개했습니다.",
    problem:
    ...
    result:
      "2024년 5월부터 2,260편을 썼고 현재 1,328편이 공개돼 있습니다. 한국어 664편, 영어 664편입니다. " +
      "한 번 게시한 주소가 죽지 않도록 URL 래칫을 CI에 걸어 두 언어를 같은 품질 기준으로 유지합니다.",
    metrics: [
      { k: "누적 작성", v: "2,260편 · 공개 1,328편" },
      { k: "언어", v: "한국어 · 영어" },
      { k: "카테고리", v: "11개" }
    ],
  ...
  },
  {
    ...
    tags: ["제품", "오픈소스", "로컬 우선"],
    link: { label: "내려받기 페이지", url: "https://hyojunguy.github.io/hanji-download/" },
    featured: true
  },
  {
    id: "2i-studio",
...
export const contact = {
  ...
  links: [
    ...
    { label: "GitHub", url: "https://github.com/hyojunguy", kind: "github" },
